              ...
              <form dir='rtl' className='space-y-6 text-right'>
                ...
                <div className='w-full flex flex-col md:flex-row gap-4'>
                  <Button
                    ...
                    className='w-full md:w-1/2 h-14 text-xl font-semibold bg-[#CAAB73] hover:bg-[#664c43] focus:bg-[#664c43] active:bg-[#664c43] text-white rounded-xl transform hover:scale-105 active:scale-105 focus:scale-105 transition-all duration-300 shadow-xl'
                  >
