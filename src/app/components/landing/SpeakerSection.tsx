          ...
          >
            <div dir="rtl" className='space-y-6'>
              ...
              <div className='space-y-4 text-lg text-neutral-700 leading-relaxed'>
                <p>
                  נשואה ואמא ל־3 ילדים. מעל 3 עשורים בעולם המספרים ובשנים
                  האחרונות גיליתי בהם את העומק הרוחני והעומקי ואת היכולת שלהם
                  לשקף, לתת כלים ולהעניק הכוונה. אני עורכת מפגשים אישיים תוך
                  ניתוח ואבחון מפות נומרולוגיות, מרצה ומקיימת סדנאות ומפגשי
                  העצמה ומסייעת
                  <strong> להגשים, לממש ולמקסם את הפוטנציאל במסע חיינו.</strong>
                </p>
                <p className='font-bold text-[#664c43]'>
