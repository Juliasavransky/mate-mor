  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center overflow-hidden'>
      ...
      {/* <div className="absolute inset-0" style={{
        backgroundImage: `radial-gradient(circle at 20% 80%, rgba(164, 134, 79, 0.1) 0%, transparent 50%),
      ...
      <div className='relative z-10 max-w-6xl mx-auto px-6 text-center'>
        ...
        >
          ...
          {/* Main Headline */}
          <h1 className='text-5xl md:text-7xl font-bold text-[#3b3b3b] leading-tight'>
          ...
          {/* Event Details */}
          <div className='bg-[#F5D9A5]/50 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 max-w-3xl mx-auto'>
            <div className='grid md:grid-cols-3 gap-6 text-center'>
              <div className='flex flex-col items-center space-y-2'>
                <Calendar className='w-8 h-8 text-[#A4864F]' />
                <div>
                  <p className='font-semibold text-[#3b3b3b]'>יום ראשון</p>
                  <p className='text-neutral-600'>14 בספטמבר 2025</p>
                </div>
              </div>
              <div className='flex flex-col items-center space-y-2'>
                <Clock className='w-8 h-8 text-[#A4864F]' />
                <div>
                  <p className='font-semibold text-[#3b3b3b]'>18:00-21:00</p>
                  <p className='text-neutral-600'>3 שעות של השראה</p>
                </div>
              </div>
              <div className='flex flex-col items-center space-y-2'>
                <MapPin className='w-8 h-8 text-[#A4864F]' />
                <div>
                  <p className='font-semibold text-[#3b3b3b]'>אשכול פייס</p>
                  <p className='text-neutral-600'>בת ים</p>
                </div>
              </div>
            </div>
          </div>
